...
export interface ApiCateArticleCateArticle extends Schema.CollectionType {
  collectionName: 'cate_articles';
  info: {
...
export interface ApiDataRankDataRank extends Schema.CollectionType {
  collectionName: 'data_ranks';
  info: {
    singularName: 'data-rank';
    pluralName: 'data-ranks';
...
export interface ApiNavbarNavbar extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String;
    subNavbar: Attribute.Component<'sub-navbar.sub-navbar', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiProductsProducts extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::products.products', 'name'> & Attribute.Required;
    categoryProducts: Attribute.Relation<
      'api::products.products',
      'oneToMany',
      'api::category.category'
    >;
    brandProduct: Attribute.Relation<
      'api::products.products',
      'oneToOne',
      'api::brand.brand'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::data-rank.data-rank': ApiDataRankDataRank;
